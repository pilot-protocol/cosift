...
| `COSIFT_ZOMBIE_RECLAIM` | bool (`"1"`) | unset → off | When `"1"`, marks a re-crawled URL's prior chunk generation invalid in the HNSW graph before adding fresh vectors. | `crawler.go:666,1320`; `wet.go:309` |
