...
See [docs/PEBBLE.md](docs/PEBBLE.md) for the Pebble storage design, tuning knobs, and iter map; [docs/API.md](docs/API.md) for the `pebble-serve` HTTP surface reference (curl examples + response shapes).
